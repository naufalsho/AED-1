...
function FormatDateTimeToString(dateTimeToFormat) {
    // Menggunakan library moment.js untuk memproses tanggal dan waktu
    return DateTime.fromISO(dateTimeToFormat).setLocale('id').toFormat('dd/LL/yyyy HH:mm:ss');

    // return moment(dateTimeToFormat, 'DD/MM/YYYY HH:mm:ss').format('DD/MM/YYYY HH:mm:ss');
}
