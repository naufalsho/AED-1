        ...
        columns: [
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    return `<img src="/assets/images/qrcode/${row.yardQRCode == null || row.yardQRCode == "" ? "noimage.jpg" : row.yardQRCode }" alt="Product Image" style="max-width: 60px;" />`;
