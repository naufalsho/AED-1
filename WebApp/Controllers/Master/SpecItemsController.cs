...
{
    [Route("SpecItems")]
    public class SpecItemsController : BasePageController
    {
        private readonly ICommonService _commonSvc;
        private readonly ITMstSpecItemsService _mstSpecItemsService;

        public SpecItemsController(ICommonService commonSvc, ITMstSpecItemsService mstSpecItemsService)
        {
            _commonSvc = commonSvc;
            _mstSpecItemsService = mstSpecItemsService;
        }

        [HttpGet]
        public async Task<IActionResult> Index()
        {
            return View(ViewPath.MasterSpecItem);
        }

        [HttpGet("GetList")]
        public async Task<IActionResult> GetList()
        {
            var ret = await _mstSpecItemsService.GetAll();
        ...
        public async Task<IActionResult> CreateAsync()
        {
            ...
            var getLastCode = await _mstSpecItemsService.GetLastCode();

            var ret = new TMstSpecItemsCreatedDto
            {
                Code = getLastCode.Value,
                IsActive = true,
                Category = await _commonSvc.SLGetCategory(),
            };

            return View(ViewPath.MasterSpecItemProcess, ret);
        }

        [HttpPost("Create")]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create(TMstSpecItemsCreatedDto data)
        {
            ...
            var ret = await _mstSpecItemsService.Create(User.GetUserClaims(), data);
        ...
        public async Task<IActionResult> Edit(string Id)
        {
            ...
            var result = await _mstSpecItemsService.GetById(Id);

            ret.Code = result.Value.Code;
            ret.Items = result.Value.Items;
            ret.SubItems = result.Value.SubItems;
            ret.IsActive = result.Value.IsActive;
            ret.CategoryCode = result.Value.CategoryCode;
        ...
        [HttpPost("Edit")]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(TMstSpecItemsCreatedDto data)
        {


            var ret = await _mstSpecItemsService.Update(User.GetUserClaims(), data);
        ...
        {
            var ret = await _mstSpecItemsService.Delete(User.GetUserClaims(), id);
