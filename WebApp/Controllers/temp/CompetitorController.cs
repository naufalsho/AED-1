...
{
    [Route("[Controller]")]
    public class CompetitorController : BasePageController
    {
        private readonly ICommonService _commonSvc;
        private readonly IMasterComparisonService _mstComparisonService;

        public CompetitorController(ICommonService commonSvc, IMasterComparisonService mstComparisonService)
        {
        ...
        {
            return View(ViewPath.MasterCompetitor);
        }
