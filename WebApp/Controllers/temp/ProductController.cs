...
{
    [Route("[Controller]")]
    public class ProductController : BasePageController
    {
        private readonly ICommonService _commonSvc;
        private readonly IMasterComparisonService _mstComparisonService;

        public ProductController(ICommonService commonSvc, IMasterComparisonService mstComparisonService)
        {
        ...
        {
            return View(ViewPath.MasterProduct);
        }
