...
{
    [Route("[Controller]")]
    public class SpecCategorizeController : BasePageController
    {
        private readonly ICommonService _commonSvc;
        private readonly IMasterComparisonService _mstComparisonService;

        public SpecCategorizeController(ICommonService commonSvc, IMasterComparisonService mstComparisonService)
        {
        ...
        {
            return View(ViewPath.SpecCategorize);
        }
