...
namespace WebApp.Controllers
{
    ...
    public class MasterProductController : BasePageController
    {
        private readonly ICommonService _commonSvc;
        private readonly IMasterGeneralService _mdSvc;

        private string mdTypeChange = MasterDataType.ProductBrand;
        private string mdView = ViewPath.MDGeneralParent;
        private string mdText = "Product Brand";
        ...
        private void SwitchController(string type, bool isModal = false)
        {
            ...
            {
                case "type" or "types":
                    mdTypeChange = MasterDataType.ProductType;
                    mdText = "Product Type";
                    ...
                    break;
                default:
                    mdTypeChange = MasterDataType.ProductBrand;
                    mdText = "Product Brand";
        ...
        public async Task<IActionResult> Edit(string mdType, int id)
        {
            ...
            if (ret.IsSuccess)
            {
                ...
                // if (mdTypeChange == MasterDataType.ProductType)
                // {
                //     ret.Value.Parents = await _commonSvc.SLGetMasterDataGeneral(MasterDataType.ProductBrand);
                // }
