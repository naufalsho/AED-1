...
{
    [Route("[Controller]")]
    public class ComparisonTypeController : BasePageController
    {
        private readonly ICommonService _commonSvc;
        private readonly IMasterComparisonService _mstComparisonService;

        public ComparisonTypeController(ICommonService commonSvc, IMasterComparisonService mstComparisonService)
        {
        ...
        {
            return View(ViewPath.MasterComparisonType);
        }
